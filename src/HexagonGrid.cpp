...
void HexagonGrid::initialize(const int &rows, const int &columns,const int & width, const int & height)
{
    ...
    this->m_grid = new common::utility::math::Hexagon [m_count];
...
const common::utility::math::Hexagon *HexagonGrid::getHexagon(const size_t &index)
{
    return (index<this->m_count)?&this->m_grid[index]:0;
}

const common::utility::math::Hexagon *HexagonGrid::getHexagon(const size_t &row, const size_t &column)
{
